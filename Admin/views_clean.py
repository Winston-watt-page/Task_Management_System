...
def dashboard_view(request):
    ...
    if is_admin(user):
        ...
        return render(request, 'admin/dashboard_tl.html', context)
        ...
        return render(request, 'admin/dashboard_scrum_master.html', context)
        ...
        return render(request, 'admin/dashboard_user.html', context)
...
def user_create_view(request):
    ...
    return render(request, 'admin/user_create.html', {'groups': groups})
...
def group_create_view(request):
    ...
    return render(request, 'admin/group_create.html')
...
def admin_backlog_view(request):
    ...
    return render(request, 'admin/backlog.html', {
        'projects': projects,
        'issues': issues
    })
